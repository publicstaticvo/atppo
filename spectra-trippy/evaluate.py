            ...
            if i['slot_prediction_' + slot] == i['slot_groundtruth_' + slot]:
                ...
                if i['slot_groundtruth_' + slot] in label_maps:
                    ...
                    if match == 0 and i['slot_prediction_' + slot] != 'none' and i['guid'][2] == last[i['guid'][1]]:
                        # print()
                        wrong_match.append(
                            (i['guid'], slot, i['slot_groundtruth_' + slot], i['slot_prediction_' + slot]))
                    right *= match
                    ...
                    right = 0
                    if i['guid'][2] == last[i['guid'][1]] and (
                            i['slot_prediction_' + slot] != 'none' and i['slot_groundtruth_' + slot] != 'none'):
