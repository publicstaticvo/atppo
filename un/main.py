...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_phase", default=1, type=int, choices=[1, 2])
    ...
    config.train_phase = args.train_phase
    ...
    for i in outer_it:
        ...
        for j, batch in enumerate(inner_it):
            ...
            if not args.dont_show and get_rank() == 0:
                inner_it.set_postfix_str(f"MLM: {mlm_loss:.4f} MAM: {mam_loss:.4f} R-S: {rs_loss:.4f}")
