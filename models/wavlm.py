...
class WavLMForMultiModal(WavLMPreTrainedModel):
    ...
    def forward(self, input_values, attention_mask, perform_mam=False, token_embedding=None, perform_crs=False):
        ...
        hidden_states, attention_mask, token_type_ids, masked_indices, mam_labels = self.concat_multi_turn(hidden_states, attention_mask, real_length=out_len, masked_indices=masked_indices, mam_labels=mam_labels, mam=perform_mam, crs=perform_crs)
...
class WavLMForMultiTurn(WavLMForMultiModal):
    ...
    def concat_multi_turn(self, hidden_states, attention_mask, real_length=None, masked_indices=None, mam_labels=None, mam=False, crs=False, *args, **kwargs):
        if crs:
